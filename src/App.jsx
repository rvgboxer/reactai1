...
const App = () => {
  ...
  const generateResponse = async (msg) => {
    ...
    const genAI = new GoogleGenerativeAI("AIzaSyArzbrx1aiSYu8yGMoVkxSZGVyPYRHvM70");
    ...
    <>
      <div className="container w-screen min-h-screen overflow-x-hidden bg-[#0E0E0E] text-white">
          ...
          isResponseScreen ?
            <div className='h-[80vh]'>
              <div className="header pt-[25px] flex items-center justify-between w-[100vw] px-[300px]">
                <h2 className='text-2xl'>Anand ai</h2>
            ...
            <div className="middle h-[80vh] flex items-center flex-col justify-center">
              <h1 className='text-4xl'>Anand ai</h1>
        ...
        <div className="bottom w-[100%] flex flex-col items-center">
          ...
          <p className='text-[gray] text-[14px] my-4'>Anand ai is developed by Anandaperumal.guided by Priya mam. this AI use the gemini API for giving the response  </p>
        </div>
      </div>
    </>
  )
